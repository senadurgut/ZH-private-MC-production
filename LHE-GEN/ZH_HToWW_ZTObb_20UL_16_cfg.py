...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGEN-01510-fragment.py nevts:125'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ZH_HToWW_ZTobb_20UL_16.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ZH_HToWW_ZTobb_20UL_16_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/tmp/HZJ_Hto2Wto2L2Nu_modified.tgz'),
    nEvents = cms.untracked.uint32(125),
    numberOfParameters = cms.uint32(1),
    outputFile = cms.string('cmsgrid_final.lhe'),
    scriptName = cms.FileInPath('GeneratorInterface/LHEInterface/data/run_generic_tarball_cvmfs.sh')
)

process.ZtoBBFilter = cms.EDFilter("MCParticlePairFilter",
    Status = cms.untracked.vint32(2, 2),  # status 2 = from hard process (or 3, depending on generator)
    ParticleID1 = cms.untracked.vint32(5),    # b-quark
    ParticleID2 = cms.untracked.vint32(-5),   # anti-b
)
...
process.lhe_step = cms.Path(process.externalLHEProducer * process.ZtoBBFilter)
